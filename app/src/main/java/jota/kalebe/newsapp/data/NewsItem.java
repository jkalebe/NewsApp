package jota.kalebe.newsapp.data;
...
public class NewsItem {
    ...
    String bgColor;
    Date dateCreation;
    int viewType = 0; //required to determine the viewtype 0 for simple news type(text based news) 1 for image based 2 for news that contains video...
    String videoUrl;
    boolean isFav = false;
